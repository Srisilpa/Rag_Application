...
class FaissVectorStore:
    ...
    def build_from_documents(self, documents: List[Any]):
        ...
        # Use your EmbeddingPipeline from the previous step
        ...
        # 4. Add to FAISS (ensure float32 for compatibility)
    ...
    def load(self):
        ...
        if os.path.exists(faiss_path) and os.path.exists(meta_path):
            ...
            print("[ERROR] Store not found. Build it first!")
    ...
    def query(self, query_text: str, top_k: int = 5):
        ...
        # Turn user text into math (embedding)
